...
Open(unit=10,file='ScriptLorentzian.bat')
Do i = start, end
...
write(10,'(a, I3.3, a)') "move Outputs\IngoingOutOfBounds.txt Batch",i,"\Outputs"
write(10,'(a, I3.3, a)') "move Outputs\ScatteredOutOfBounds.txt Batch",i,"\Outputs"
...
write(10,'(a, I3.3, a)') "move Outputs\Abs_005.txt Batch",i,"\Outputs\"
write(10,'(a, I3.3, a)') "move Outputs\Abs_006.txt Batch",i,"\Outputs\"
...
write(10,'(a, I3.3, a)') "move Outputs\FMabs_005.txt Batch",i,"\Outputs\"
write(10,'(a, I3.3, a)') "move Outputs\FMabs_006.txt Batch",i,"\Outputs\"
...
write(10,'(a, I3.3, a)') "move Outputs\SpeedDistr_005.txt Batch",i,"\Outputs\"
write(10,'(a, I3.3, a)') "move Outputs\SpeedDistr_006.txt Batch",i,"\Outputs\"
...
write(10,'(a, I3.3, a)') "move Outputs\Processing1\Output_005.txt Batch",i,"\Outputs\Processing1\"
write(10,'(a, I3.3, a)') "move Outputs\Processing1\Output_006.txt Batch",i,"\Outputs\Processing1\"
